export default function About() {
  return (
    <section id="about" className="py-20 bg-pure-white">
      <div className="max-w- mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">

        <div className="lg:col-span-5 flex justify-center">
          <div className="w-full max-w-md bg-mist-gray rounded p-8 text-center border border-ink-black/5">
            <div className="w-20 h-20 bg-pure-white text-forest-grove rounded flex items-center justify-center mx-auto mb-4 border border-ink-black/5">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="text-graphite text-base leading-relaxed max-w">
